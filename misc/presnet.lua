...
--
--
-- Taken from https://github.com/facebook/fb.resnet.torch/blob/master/models/preresnet.lua
--
...
local function createModel(opt)
   ...
   if opt.dataset == 'imagenet' then
      ...
      model:add(ReLU(true))
      model:add(Avg(5, 2, 1, 1))
      model:add(nn.View(nFeatures):setNumInputDims(3))
      model:add(nn.Linear(nFeatures, opt.descriptor_size))
